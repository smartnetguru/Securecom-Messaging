...
public class ContentType {
    ...
    public static final String OTHER_ANY         = "application/octet-stream";
    ...
    private static final ArrayList<String> sSupportedOtherTypes = new ArrayList<String>();
    ...
    static {
        ...
        // add supported other types
        sSupportedOtherTypes.add(OTHER_ANY);
    }
    ...
    public static boolean isSupportedOtherType(String contentType){
        return isOtherType(contentType) && isSupportedType(contentType);
    }
    ...
    @SuppressWarnings("unchecked")
    public  static ArrayList<String> getOtherTypes() {
        return (ArrayList<String>) sSupportedOtherTypes.clone();
    }
}

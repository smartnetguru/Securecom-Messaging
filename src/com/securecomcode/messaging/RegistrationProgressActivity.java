...
public class RegistrationProgressActivity extends SherlockActivity {
  ...
  public void onCreate(Bundle bundle) {
    ...
    if(TextSecurePreferences.getRegistrationOptionSelected(getApplicationContext()).equalsIgnoreCase("Phone")){
        ...
        getSupportActionBar().setTitle(getString(R.string.RegistrationProgressActivity_verifying_email));
    }
  ...
  private void initializeResources() {
    ...
    this.voiceImage                = (ImageView) findViewById(R.id.telephone);
      ...
      if(TextSecurePreferences.getRegistrationOptionSelected(getApplicationContext()).equalsIgnoreCase("Phone")){
          this.verificationText.setText(R.string.registration_progress_activity__waiting_for_sms_verification);
      }else if(TextSecurePreferences.getRegistrationOptionSelected(getApplicationContext()).equalsIgnoreCase("Email")){
  ...
  private void handleEmailVerificationTimeout(RegistrationState state){
      ...
      verificationFailureWaitingLabel.setText(R.string.registration_progress_activity__securecom_messaging_timed_out_while_waiting_for_a_verification_email_message);
  ...
  private class RegistrationStateHandler extends Handler {
    ...
    public void handleMessage(Message message) {
      ...
      case RegistrationState.STATE_SMS_VERIFICATION:     handleSmsVerification(state);            break;

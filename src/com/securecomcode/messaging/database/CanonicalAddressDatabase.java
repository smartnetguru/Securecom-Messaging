...
import com.securecomcode.messaging.util.VisibleForTesting;
...
public class CanonicalAddressDatabase {
    ...
    private long getCanonicalAddressIdFromDatabase(String address) {
      ...
      if(org.whispersystems.textsecure.internal.util.Util.isValidEmail(address)){
          cursor                      = db.query(TABLE, null, EMAIL_SELECTION, selectionArguments, null, null, null);
      }else{

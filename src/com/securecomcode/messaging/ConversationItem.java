...
import com.securecomcode.messaging.util.DateUtils;
...
public class ConversationItem extends LinearLayout {
    ...
    private class ThumbnailClickListener implements View.OnClickListener {
        ...
        private void fireIntent() {
            ...
            if (!slide.getContentType().equalsIgnoreCase("application/octet-stream")) {
                try {
                    ...
                    Log.w(TAG, anfe);
                    Toast.makeText(context, R.string.registration_conversation_item_other_content_not_supported_toast_label, Toast.LENGTH_LONG).show();
                }
            } else {
                Toast.makeText(context, R.string.registration_conversation_item_other_content_not_supported_toast_label, Toast.LENGTH_LONG).show();
            }

...
import com.securecomcode.messaging.DummyActivity;
...
public class KeyCachingService extends Service {
  ...
  public  static final String KEY_PERMISSION           = "com.securecomcode.messaging.ACCESS_SECRETS";
  public  static final String NEW_KEY_EVENT            = "com.securecomcode.messaging.service.action.NEW_KEY_EVENT";
  public  static final String CLEAR_KEY_EVENT          = "com.securecomcode.messaging.service.action.CLEAR_KEY_EVENT";
  private static final String PASSPHRASE_EXPIRED_EVENT = "com.securecomcode.messaging.service.action.PASSPHRASE_EXPIRED_EVENT";
  public  static final String CLEAR_KEY_ACTION         = "com.securecomcode.messaging.service.action.CLEAR_KEY";
  public  static final String DISABLE_ACTION           = "com.securecomcode.messaging.service.action.DISABLE";
  public  static final String ACTIVITY_START_EVENT     = "com.securecomcode.messaging.service.action.ACTIVITY_START_EVENT";
  public  static final String ACTIVITY_STOP_EVENT      = "com.securecomcode.messaging.service.action.ACTIVITY_STOP_EVENT";
  ...
  private void foregroundServiceModern() {
    ...
    builder.setContentText(getString(R.string.KeyCachingService_securecom_messaging_passphrase_cached));
  ...
  private void foregroundServiceLegacy() {
    Notification notification  = new Notification(R.drawable.icon_cached,
                                                  getString(R.string.KeyCachingService_securecom_messaging_passphrase_cached),
